...
function filterProductsByCategory(categoryName) {
  const filteredProducts = allProducts.filter(product => 
    product.category && product.category.toUpperCase() === categoryName.toUpperCase()
  );
  displayProducts(filteredProducts);
...
document.querySelector(".close-btn").addEventListener("click", toggleFilterMenu);
document.querySelector("#filterMenu button").addEventListener("click", applyFilters);
